...
def main(config):
    ...
    wandb.init(project="ViTLoc", name="PoseFormer - Training2 - KingsCollege", config=config)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='Resnet', choices=['Googlenet', 'Resnet', 'ViT'])
