        ...
        for epoch in range(start_epoch, num_epochs):
            ...
            for phase in ['train', 'val']:
                ...
                for i, (inputs, poses) in enumerate(data_loader):
                    ...
                    err_pos.append(loss_pos_print)
                    err_ori.append(loss_ori_print)
                    ...
                    # wandb.log({'{}th {} Loss'.format(i, phase): {'total_loss': loss_print, 'pos_loss': loss_pos_print, 'ori_loss': loss_ori_print}})
            ...
            print('=' * 40)
            print('=' * 40)
            # wandb.log({'Train and Validation Error': {'train_loss': error_train_loss, 'val_loss': error_val_loss}})
            wandb.log({ 'epoch': epoch+1,
                        'train_loss': error_train_loss,
                        'val_loss': error_val_loss,
                        'position_error': np.mean(err_pos),
                        'orientation_error': np.mean(err_ori),
